...
function gsp_plot_graph_sm(G,param)
...
G.plotting.vertex_size
            scatter(G.coords((nodeLabel==1),1),G.coords((nodeLabel==1),2),...
            G.plotting.vertex_size,'MarkerFaceColor',cluster_colors(i, :),...
            'MarkerEdgeColor',G.plotting.vertex_color, 'Marker','*');

            scatter(G.coords((nodeLabel==2),1),G.coords((nodeLabel==2),2),...
            G.plotting.vertex_size,'MarkerFaceColor',cluster_colors(i, :),...
