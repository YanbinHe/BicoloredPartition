...
function gsp_plot_signal_ox(G,signal,param)
...
if size(G.coords,2) == 2
    if param.bar
        ...
        for i = 1:size(G.coords,1)
            if     signal(i) == 1 && G.label_N(i) == 0 
            scatter(G.coords(i,1),G.coords(i,2),G.sz,'bo','LineWidth',1.5);
            elseif signal(i) == 2 && G.label_N(i) == 0
            scatter(G.coords(i,1),G.coords(i,2),G.sz,'ro','LineWidth',1.5);
            elseif signal(i) == 1 && G.label_N(i) == 1
            scatter(G.coords(i,1),G.coords(i,2),G.sz,'bx','LineWidth',1.5);
            elseif signal(i) == 2 && G.label_N(i) == 1
            scatter(G.coords(i,1),G.coords(i,2),G.sz,'rx','LineWidth',1.5);
            elseif signal(i) == 3 && G.label_N(i) == 0
            scatter(G.coords(i,1),G.coords(i,2),G.sz,'ko','LineWidth',1.5);
            elseif signal(i) == 4 && G.label_N(i) == 0
            scatter(G.coords(i,1),G.coords(i,2),G.sz,'go','LineWidth',1.5);
            elseif signal(i) == 3 && G.label_N(i) == 1
            scatter(G.coords(i,1),G.coords(i,2),G.sz,'kx','LineWidth',1.5);
            elseif signal(i) == 4 && G.label_N(i) == 1
            scatter(G.coords(i,1),G.coords(i,2),G.sz,'gx','LineWidth',1.5);
            end
        end
%         if any(param.vertex_highlight > 0)
%             vh = param.vertex_highlight;
